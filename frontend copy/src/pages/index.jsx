...
class Index extends Component {
  ...
  async handleFormEvent(event) {
    ...
    let data = event.target.note.value;
    ...
    const eos = Eos({keyProvider: '5JN7GUBvxbpY3NRg755HzJqpWg7FbupKkP8wKZbMX4hk3ei7RvS', httpEndpoint: 'http://127.0.0.1:8888'});
  ...
  getTable() {
    ...
    eos.getTableRows({
      "json": true,
      "code": "hacksfac",   // contract who owns the table
      "scope": "hacksfac",  // scope of the table
      "table": "hackstruct",    // name of the table as specified by the contract abi
      "limit": 100,
